...
<body>
	<h3>set,out</h3> <!-- 페이지 안에서 값을 저장 -->
	<c:set var= "product1" value="<h2>애플 아이폰</h2>"/>
	<c:set var= "product2" value="삼성 갤럭시 노트"/>
	<c:set var= "intArray" value="${[1,2,3,4,5]}"/> <!-- 1에 밑줄 이클립스 버그 -->
	<p>
	...
	<c:if test="${! empty product2}"> <!-- empty:비어있지 않은지 검사 -->
	...
	<h3>forTokens</h3>
	<c:forTokens var="city" items="상하이|베이징|충칭|쓰촨" delims="|" varStatus="i">
	${city}
